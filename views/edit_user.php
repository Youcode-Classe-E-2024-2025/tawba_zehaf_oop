...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        ...
        <?php endif; ?>
        <form action="index.php?action=edit_user&id=<?php echo $user['id']; ?>" method="post"
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="username" type="text" name="username" value="<?php echo htmlspecialchars($user['username']); ?>"
                    required>
            </div>
            <div class="mb-4">
